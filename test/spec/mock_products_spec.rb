...
describe MockProducts do
  ...
  it "should get price of 0.0£ when product code is GR1" do   
    expect(MockProducts.get_price("GR1")).to eq(3.11)  
  end

  it "should get price of 0.0£ when product code is SR1" do   
    expect(MockProducts.get_price("SR1")).to eq(5.00)  
  end 

  it "should get price of 0.0£ when product code CF1" do    
